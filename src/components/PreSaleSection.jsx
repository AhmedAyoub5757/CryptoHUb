...
const presaleData = [
  ...
  { title: "Low - High 14h", date: "$ 3,155.63 - $ 5,12.62", bg: "bg-[#7868e6]" },
  { title: "Total Token Sale ", date: "412,573 BCC (4.2%)", bg: "bg-[#ff0066d9]" },
  { title: "Acceptable Currency", date: "BTC, ETH, LTC", bg: "bg-[#00008b]" },
];
...
const PreSaleSection = () => {
  ...
  return (
    <section
      className="w-full py-10 px-6 lg:px-24 bg-white text-center"
      id="presale"
      data-aos="fade-up"
    >
