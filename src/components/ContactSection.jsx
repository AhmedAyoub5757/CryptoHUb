...
const ContactSection = () => {
  return (
    <section className="px-4 md:px-20 py-16 bg-white" id='contact'>
      {/* Heading */}
      ...
      {/* Form */}
      <form className="max-w-3xl mx-auto bg-white  rounded-lg p-6 space-y-6">
        {/* Name and Email Row */}
        ...
        <button
          type="submit"
          className="w-full bg-[rgba(255,0,102,0.85)]  hover:bg-purple] 
 text-white py-3 rounded-[24px] font-medium transition-colors"
        >
          Send Message
        </button>
      </form>
