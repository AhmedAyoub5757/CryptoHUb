...
const Timeline = ({ events }) => {
  return (
    <div className="relative w-full max-w-4xl mx-auto py-12" id="roadmap">
      <h2 className="text-4xl font-bold text-center text-gray-800 font-sans mb-4">
        The Roadmap
      </h2>
      ...
      <div
        className="absolute left-1/2 transform -translate-x-1/2 h-[1100px] w-0.5"
          ...
          {item.position === 'left' ? (
            <>
              ...
              <div className="w-1/2 pl-8 flex items-center justify-start">
                ...
                <div
                  className="w-20 h-0.5 absolute left-1/2 top-1/2"
                  style={{ backgroundColor: customPurple }}
                ></div>
                <div
                  className="w-24 h-24 rounded-full border-2 flex items-center justify-center relative z-10"
                  style={{ borderColor: customPurple, backgroundColor: 'white' }}
                >
                  <span
              ...
              <div
                className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full border-2 bg-white"
                style={{ borderColor: customPurple }}
              ></div>
            </>
          ) : (
            <>
              ...
              <div className="w-1/2 pr-8 flex items-center justify-end">
                {/* Horizontal line extending from the circle to the center line */}
                <div
                  className="w-20 h-0.5 absolute right-1/2 top-1/2"
                  style={{ backgroundColor: customPurple }}
                ></div>
                <div
                  className="w-24 h-24 rounded-full border-2 flex items-center justify-center relative z-10"
